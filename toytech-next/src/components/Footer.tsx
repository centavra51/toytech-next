      ...
      <div className="mx-auto max-w-[1380px] px-6">
        <div className="mb-16 grid items-start gap-12 lg:grid-cols-[1.15fr_1fr_1fr_1.1fr]">
          ...
          <div className="space-y-6">
            <h2 className="text-xl font-black text-white">{t.footer.services}</h2>
          ...
          <div className="space-y-6">
            <h2 className="text-xl font-black text-white">{t.footer.company}</h2>
            <ul className="space-y-4">
              <li>
                  <Link
          ...
          <div className="space-y-6">
            <h2 className="text-xl font-black text-white">{t.footer.contacts}</h2>
